...
const intervieweePointsForInAppAv = [
  ...
  'Do not change, remove, or weaken the problem statement, sample checks, assert statements, or validation code included with a question. Tampering with validation or assert statements is recorded as a question-integrity issue and may be treated as suspicious during evaluation.',
