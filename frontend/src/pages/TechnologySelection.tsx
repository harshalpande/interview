    ...
    <div className="page-shell">
      <div className="page-card tech-selection-card">
        ...
        <p className="page-subtitle">
          Choose the stack for this interview. Java, Python, Angular, and React are available now, and the remaining technologies are visible as upcoming options.
        </p>
          ...
          <div className="hint-panel tech-hint">
            ...
            <p>
              {canProceed
                ...
                : selectedOption
                  ? 'This technology is not enabled yet. Please select Java, Python, Angular, or React to continue.'
                  : 'Select Java, Python, Angular, or React to continue.'}
            </p>
          </div>
